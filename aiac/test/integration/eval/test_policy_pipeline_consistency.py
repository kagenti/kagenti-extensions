"""PRB run-to-run consistency suite (spec: ``docs/specs/integration-test/
...
Run (needs LLM_BASE_URL/LLM_MODEL/LLM_API_KEY exported; no Keycloak/opa needed):
    .venv/bin/pytest test/integration/eval/test_policy_pipeline_consistency.py \
...
pytestmark = pytest.mark.integration_consistency
