"""PRB robustness-to-perturbation suite (spec: ``docs/specs/integration-test/
...
Run (needs LLM_BASE_URL/LLM_MODEL/LLM_API_KEY exported; no Keycloak/opa needed):
    .venv/bin/pytest test/integration/eval/test_policy_pipeline_robustness.py \
        -m integration_robustness -v
"""
...
pytestmark = pytest.mark.integration_robustness
...
from test.integration.eval.prb_direct import build_roles_and_scopes  # noqa: E402
from test.integration.eval.scenarios_perturbed import (  # noqa: E402
...
from test.integration.eval.test_policy_pipeline_eval import (  # noqa: E402
    SCENARIOS,
    grant_sets,
    orchestrate_prb,
    truth,
