...
- The developer role can use both the repo-access and tracker-access capabilities.
- The tester role can use the tracker-access capability.
...
- The repo_operations role covers reading and writing the repository.
- The tracker_operations role covers reading and writing the tracker.
